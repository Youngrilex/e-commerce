...
function Shop() {
  ...
  return (
    <Suspense fallback={<Loading />}>
      <div className="bg-blue-400 mx-auto pt-24 p-4">
        <div className="flex flex-col md:flex-row items-center justify-center md:space-x-4 space-y-4 md:space-y-0 my-3">
          ...
          <button
            ...
            className="bg-blue-800 rounded-md px-4 py-2 text-white text-xl font-semibold focus:outline-none focus:ring-2 focus:ring-primary"
          >
